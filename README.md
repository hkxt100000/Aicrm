...
> 🍎 **设计规范**：遵循 [Apple Human Interface Guidelines](https://developer.apple.com/design/human-interface-guidelines/)
...
| 文档 | 说明 |
|------|------|
| [Apple设计规范检查清单.md](../文档归档/Apple设计规范检查清单.md) | 📐 **完整设计规范**（颜色、圆角、阴影、间距、字体、按钮、卡片、表单、模态框、动画） |
| [Apple设计规范-快速参考.md](../文档归档/Apple设计规范-快速参考.md) | 📋 **快速参考卡**（常用样式速查表） |

### CSS 文件结构

| 文件 | 说明 |
|------|------|
| `apple-design-system.css` | 🎨 设计系统基础库（CSS 变量、工具类） |
| `apple-ui-master.css` | 🔘 UI 组件库（按钮、表单、模态框、表格） |
| `apple-ui-reset.css` | 🔄 样式重置 |
| `apple-dialogs.css` | 💬 对话框样式 |
| `common-modules-apple.css` | 📦 通用模块样式（卡片、筛选器） |
| `customer-list-apple.css` | 👥 客户列表样式 |
| `customer-profile-apple.css` | 📇 客户详情样式 |
| `employee-permission-apple.css` | 👔 员工权限样式 |
